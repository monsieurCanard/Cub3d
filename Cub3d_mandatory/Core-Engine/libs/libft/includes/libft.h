...
/*   Updated: 2024/04/25 17:52:58 by jbrousse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Detaches the specified node from the list.
 * 
 * @param lst A pointer to the pointer to the list.
 * @param current_index The node to be detached.
 ...
 * 
 * @param head_ref A pointer to the pointer to the head of the list.
 * @param cmp The comparison function to be applied to the nodes' content.
 * 
 * @warning the 'cmp' function must non-null
*/
...
/**
 * @brief Duplicates the queue using the provided duplication function.
 *
 * @param queue        A pointer to the queue to be duplicated.
 * @param dup_content  The duplication function to be applied to each node's
 * 	content.
...
/**
 * @brief Returns the content of the node at the specified index in the queue.
 *
 * @param queue A pointer to the queue.
 * @param index The index of the node to peek at.
 * @return The content of the node at the specified index,
...
/**
 * @brief Calculates the length of the given null-terminated array of strings.
 * 
...
/**
 * @brief Find the first occurence of `to_find` in `str` after `index`
 * 
 * @param str The string to search in
 * @param to_find The string to find
 * @param index The index to start the search
 * 
 * @return The index of start of the first occurence of `to_find`
 * 	in `str` after `index`
*/
